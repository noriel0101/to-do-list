  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:20px_20px] flex flex-col items-center p-6 md:p-12 text-slate-800 font-sans">
      ...
      <div className="w-full max-w-2xl flex justify-between items-end mb-10">
        <div>
          <h1 className="text-4xl font-black text-slate-900 tracking-tight">What To Do?</h1>
      ...
      <div className="w-full max-w-2xl space-y-3">
        {lists.length === 0 ? (
          <p className="text-center py-10 text-slate-400 font-medium italic">No tasks found. Create your first one above!</p>
        ) : (
          lists.map(l => (
